...
caffe_root = '$HOME/caffe_ssd'  # this file is expected to be in {caffe_root}/examples
data_root  = '$HOME/data/VOCdevkit/mydataset'
dataset    = 'VOCTM2017'
...
if __name__ == '__main__':
    ...
    model_weights = caffe_root+'/models/myssd/SSD_300x300/VGG_'+dataset+'_SSD_300x300_iter_120000.caffemodel'
